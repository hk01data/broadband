...
var MapsLib = {
  ...
  fusionTableId:      "1xevjKlPil4POa0qRl5Tg0hiRmv6r85N7b3zMTVS4", //Point data layer
  
  //polygon1TableID:    "1V7biLQzaN_Zjpq2MbOYoewQiXJqFP9-wa9-ed6za", //Outline map layer of CT town boundaries
  //polygon2TableID:    "1xevjKlPil4POa0qRl5Tg0hiRmv6r85N7b3zMTVS4", //Thematic map layer of selected CT school districts

  //*MODIFY Fusion Tables Requirement* API key. found at https://code.google.com/apis/console/
  //*Important* this key is for demonstration purposes. please register your own.
  googleApiKey:       "AIzaSyDTakyp5byFWqsbaf_rDNls-RQuAQAtaLk",
  ...
  map_centroid:       new google.maps.LatLng(22.208840, 114.029392), //center that your map defaults to
  locationScope:      "香港",      //geographical area appended to all address searches
  recordName:         "result",       //for showing number of results
  recordNamePlural:   "results",

  searchRadius:       600,            //in meters ~ 1/2 mile
  defaultZoom:        18,             //zoom level when map is loaded (bigger is more zoomed in)
  ...
  //-----custom filters for point data layer
    ...
    var type_column = "'cat'";  // -- note use of single & double quotes for two-word column header
    var tempWhereClause = [];
    if ( $("#cbType1").is(':checked')) tempWhereClause.push("low");
    if ( $("#cbType2").is(':checked')) tempWhereClause.push("mid");
    if ( $("#cbType3").is(':checked')) tempWhereClause.push("high");
